    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_professional', models.BooleanField(default=False, help_text='Designa se o usuário deve ser tratado como profissional/prestador de serviço.', verbose_name='É Profissional?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=255, null=True, verbose_name='Endereço/Cidade')),
                ('cnpj', models.CharField(blank=True, help_text='Opcional, para empresas.', max_length=14, null=True, verbose_name='CNPJ')),
